...
ppi_affinity_file = "datasets/PROBE/auxilary_input/skempi_pipr/SKEMPI_all_dg_avg.txt"
...
def predict_affinities_and_report_results():
    ...
    result_df.to_csv(r"src/benchmark/PROBE/results/Affinity_prediction_skempiv1_{0}.csv".format(representation_name),index=False)
    result_detail_df.to_csv(r"src/benchmark/PROBE/results/Affinity_prediction_skempiv1_{0}_detail.csv".format(representation_name),index=False)
