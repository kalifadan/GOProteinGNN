...
def calculateCorrelationforOntology(aspect,matrix_type):
    ...
    similarityMatrixNameDict["All"] = "datasets/PROBE/preprocess/human_"+aspect+"_proteinSimilarityMatrix.csv"
    similarityMatrixNameDict["500"] = "datasets/PROBE/preprocess/human_"+aspect+"_proteinSimilarityMatrix_for_highest_annotated_500_proteins.csv"
    similarityMatrixNameDict["Sparse"] = "datasets/PROBE/preprocess/human_"+aspect+"_proteinSimilarityMatrix_for_highest_annotated_500_proteins.csv"
    similarityMatrixNameDict["200"] = "datasets/PROBE/preprocess/human_"+aspect+"_proteinSimilarityMatrix_for_highest_annotated_200_proteins.csv"
    ...
    if matrix_type == "Sparse":
        ...
        sparsified_similarity_coordinates = np.load("datasets/PROBE/auxilary_input/SparsifiedSimilarityCoordinates_"+aspect+"_for_highest_500.npy")
...
def report_detailed_distance_scores(representation_name,similarity_matrix_type,aspect,distance_lists):
    saveFileName = "src/benchmark/PROBE/results/Semantic_sim_inference_detailed_distance_scores"+aspect+"_"+similarity_matrix_type+"_"+representation_name+".pkl"
    with open(saveFileName, "wb") as f:
            pickle.dump(distance_lists, f)

def calculate_all_correlations():
    for similarity_matrix_type in similarity_tasks:
        saveFileName = "src/benchmark/PROBE/results/Semantic_sim_inference_"+similarity_matrix_type+"_"+representation_name+".csv"
