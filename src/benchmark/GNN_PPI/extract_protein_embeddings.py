...
if __name__ == '__main__':
    pretrained_model_path = "new5-gcn-output/pretrained/GOProteinGCN/checkpoint-50000/encoder"

    # 27k
    convert_protein_seq_to_embedding(
        'datasets/downstream_datasets/data/protein.SHS27k.sequences.dictionary.tsv',
        "Rostlab/prot_bert",
        pretrained_model_path,
        'datasets/downstream_datasets/data/PPI_embeddings/protein_embedding_GOProteinGCN_shs27k.npy'
    )

    # 148k 
    convert_protein_seq_to_embedding(
        'datasets/downstream_datasets/data/protein.SHS148k.sequences.dictionary.tsv',
        "Rostlab/prot_bert",
        pretrained_model_path,
        'datasets/downstream_datasets/data/PPI_embeddings/protein_embedding_GOProteinGCN_shs148k.npy'
    )

    # STRING 
    convert_protein_seq_to_embedding(
        'datasets/downstream_datasets/data/protein.STRING_all_connected.sequences.dictionary.tsv',
        "Rostlab/prot_bert",
        pretrained_model_path,
        'datasets/downstream_datasets/data/PPI_embeddings/protein_embedding_GOProteinGCN_STRING.npy'
    )
